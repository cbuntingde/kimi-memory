...
| `/kimi-memory:reset_project` | Wipe per-project memories after a re-clone (dry-run by default)                                       |
...
session tree. Everything it creates lives under the kimi-memory data
folder:

```text
<Kimi data folder>/kimi-memory/<project>/memory.sqlite
<Kimi data folder>/kimi-memory/<project>/ingest-state.json
<Kimi data folder>/kimi-memory/<project>/dreaming.json
<Kimi data folder>/kimi-memory/_global/memory.sqlite
<Kimi data folder>/kimi-memory/_shared/memory.sqlite
<Kimi data folder>/kimi-memory/_config/dreaming.json
