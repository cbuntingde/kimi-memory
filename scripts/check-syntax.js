#!/usr/bin/env node
// Syntax-check every .js file under src/, hooks/ and tests/ using
// node --check. Replaces the previous hand-maintained &&-chained file
// list in package.json: a hardcoded list cannot stay correct as the
// tree grows, and it had already drifted — it named modules that had
// since been removed (src/concurrency.js, src/lifecycle.js,
// src/performance.js, src/wiki.js) while missing every file added
// after it was written. Walking the tree removes the maintenance
// burden entirely.
//
